...
function buildGoldCatalog(): readonly ForecastLabMarkovParameterMutationCandidate[] {
  return deepFreeze([
    ...
    buildCandidate({
      ...
      patchSummary: [
        `regime-calibrator.ts: minSamplesPerRegime ${FORECAST_LAB_REGIME_CALIBRATOR_DEFAULTS.minSamplesPerRegime} → 14`,
...
const CATALOG_BY_PROFILE = deepFreeze({
  ...
  'sol-markov-short-horizon': buildCatalog('sol-markov-short-horizon'),
  'hype-markov-short-horizon': buildCatalog('hype-markov-short-horizon'),
