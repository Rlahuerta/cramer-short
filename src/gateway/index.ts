...
async function promptSetupMode(cfg: GatewayConfig, linkedPhone: string): Promise<void> {
  ...
  try {
    ...
    console.log('');
    console.log('How will you use Cramer-Short with WhatsApp?');
    console.log('  1) Self-chat  — message yourself to talk to Cramer-Short');
    console.log('  2) Bot phone  — this is a dedicated Cramer-Short phone, others message it');
    ...
    console.log('');
    console.log('Enter the phone number(s) allowed to message Cramer-Short (E.164 format, e.g. +15551234567).');
...
async function run(): Promise<void> {
  ...
  console.log('Cramer-Short gateway running. Press Ctrl+C to stop.');
