...
| Crypto           | Regulation (0.30)     | ETF/Product (0.25) | BTC Price Target (0.20) | Fed rates (0.15)    | Recession (0.10)  |
...
You have persistent memory stored as Markdown files in .cramer-short/memory/.${fileListSection}${contextSection}
...
export function getDefaultSystemPrompt(): string {
  return `You are Cramer-Short, a helpful AI assistant.
...
The heartbeat reads .cramer-short/HEARTBEAT.md to know what to check.
