...
const HEARTBEAT_MD_PATH = cramerShortPath('HEARTBEAT.md');

export const HEARTBEAT_TOOL_DESCRIPTION = `
Manage your periodic heartbeat checklist (.cramer-short/HEARTBEAT.md).
...
export const heartbeatTool = new DynamicStructuredTool({
  name: 'heartbeat',
  description:
    'View or update the heartbeat checklist (.cramer-short/HEARTBEAT.md) that controls periodic monitoring.',
